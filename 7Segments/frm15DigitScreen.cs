...
{
    public partial class frm15DigitScreen : Form
    {
        public frm15DigitScreen()
        {
            InitializeComponent();
        }
        ...
        private void ctrl15DigitScreen1_Load(object sender, EventArgs e)
        {
        ...
        void _GetInPut(string input)
        {
            ...
            {
                _sbInPut = new StringBuilder(ctrlLCDScreen1.LCDValue.ToString());
                _sbInPut.Remove(_sbInPut.Length - 1, 1);
                if (_sbInPut.ToString().Equals(string.Empty))
                {
                    _sbInPut.Clear();
                    _sbInPut.Append("000000000000000");
                    ctrlLCDScreen1.LCDValue = 0;
                    ctrlLCDScreen1.ResetScreen();
        ...
        void DoCalculation()
        {
            _Result = ctrlLCDScreen1.LCDValue;
            txtPrevOperation.Text = _PreviousOperation.ToString();
        ...
        private void frm15DigitScreen_Load(object sender, EventArgs e)
        {
            _sbInPut.Append("000000000000000");
            _InputTimes = 0;
           ctrlLCDScreen1.LCDValue  = 0;
        ...
        {
            txtScreen.Text =ctrlLCDScreen1.LCDValue .ToString();
        }

        private void btnSetLCDValue_Click(object sender, EventArgs e)
        {
           ctrlLCDScreen1.LCDValue  = 12.12365d;
        }
        ...
        {
            Form1TestNew_screen frm = new Form1TestNew_screen();
            frm.Show();
        }
